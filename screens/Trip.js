            ...
            <TouchableOpacity activeOpacity={0.8} onPress={() => {}}>
                <Card shadow style={styles.drivingStatus}>
                    ...
                    <Text 
                        ...
                        title
                        accent={item.status === 'bad'}
                        tertiary={item.status === 'fair'}
                        primary={item.status === 'good'}
                        height={22}
                    >
                        {item.status}
                    </Text>
                    <Text transform='capitalize' body>{item.action}</Text>
                </Card>
            </TouchableOpacity>
        );
    }
        ...
        return (
            <Card style={{
                ...
                >
                    ...
                    >
                        <Badge color={rgba(theme.colors.primary, '0.2')} size={144}>
                            <TouchableOpacity activeOpacity={0.8} onPress={() => alert('Howdy')}>
                                <Badge color={rgba(theme.colors.primary, '0.2')} size={62}>
                                    <MaterialCommunityIcon name='car-sports' size={62 / 2.5} color='black' />
                                </Badge>
                            </TouchableOpacity>
                        </Badge>
                    </Marker>
